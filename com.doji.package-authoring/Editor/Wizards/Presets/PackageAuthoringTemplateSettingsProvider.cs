...
namespace Doji.PackageAuthoring.Wizards.Presets {
    ...
    internal static class PackageAuthoringTemplateSettingsProvider {
        ...
        private static readonly string FaviconTextureField =
            $"<{nameof(DocsBrandingImageSettings.FaviconTexture)}>k__BackingField";

        private static readonly string LogoTextureField =
            $"<{nameof(DocsBrandingImageSettings.LogoTexture)}>k__BackingField";
        ...
        public static SettingsProvider CreateGitIgnoreTemplateProvider() {
            return new SettingsProvider("Project/Doji/Package Authoring/Templates/Package/.gitignore",
        ...
        public static SettingsProvider CreatePackageReadmeTemplateProvider() {
            return new SettingsProvider("Project/Doji/Package Authoring/Templates/Package/README",
                SettingsScope.Project) {
        ...
        public static SettingsProvider CreateCustomLicenseTemplateProvider() {
            return new SettingsProvider("Project/Doji/Package Authoring/Templates/Repository/Custom License",
                SettingsScope.Project) {
        ...
        public static SettingsProvider CreateRepositoryReadmeTemplateProvider() {
            return new SettingsProvider("Project/Doji/Package Authoring/Templates/Repository/README",
                SettingsScope.Project) {
        ...
        public static SettingsProvider CreateAgentsTemplateProvider() {
            return new SettingsProvider("Project/Doji/Package Authoring/Templates/Repository/AGENTS",
                SettingsScope.Project) {
        ...
        public static SettingsProvider CreateDocumentationTemplateProvider() {
            return new SettingsProvider("Project/Doji/Package Authoring/Templates/Documentation (DocFX)",
                SettingsScope.Project) {
        ...
        private static void DrawTemplatesGui() {
            ...
            PackageAuthoringGui.DrawSection("Available Tokens", () => {
                ...
                EditorGUILayout.SelectableLabel(
                    TemplateTokenResolver.SupportedTokensReferenceText,
        ...
        private static void DrawGitIgnoreSection() {
            ...
            PackageAuthoringGui.DrawSection(".gitignore Template", () => {
                ...
                DrawTemplateTextArea(contentProperty, ".gitignore", 420f);
            });
        ...
        private static void DrawPackageReadmeSection() {
            ...
            PackageAuthoringGui.DrawSection("Package README Template", () => {
                ...
                SerializedProperty contentProperty = serializedSettings.FindProperty(ContentField);
                DrawTemplateTextArea(contentProperty, "Package README", 220f);
            });
        ...
        private static void DrawRepositoryReadmeSection() {
            ...
            PackageAuthoringGui.DrawSection("Repository README Template", () => {
                ...
                SerializedProperty contentProperty = serializedSettings.FindProperty(ContentField);
                DrawTemplateTextArea(contentProperty, "Repository README", 260f);
            });
        ...
        private static void DrawAgentsSection() {
            ...
            PackageAuthoringGui.DrawSection("Repository AGENTS Template", () => {
                ...
                SerializedProperty contentProperty = serializedSettings.FindProperty(ContentField);
                DrawTemplateTextArea(contentProperty, "Repository AGENTS", 260f);
            });
        ...
        private static void DrawCustomLicenseSection() {
            ...
            PackageAuthoringGui.DrawSection("Custom License Template", () => {
                ...
                SerializedProperty contentProperty = serializedSettings.FindProperty(ContentField);
                DrawTemplateTextArea(contentProperty, "Custom License", 220f);
            });
        ...
        private static void DrawDocumentationTemplatesSection() {
            ...
            DrawEditableTemplateAssetSection("docs/docfx.json", DocsDocfxJsonTemplateSettings.Instance, 320f,
                () => DocsDocfxJsonTemplateSettings.Instance.SaveSettings());
            DrawEditableTemplateAssetSection("docs/docfx-pdf.json", DocsDocfxPdfJsonTemplateSettings.Instance, 360f,
                () => DocsDocfxPdfJsonTemplateSettings.Instance.SaveSettings());
            DrawEditableTemplateAssetSection("docs/filterConfig.yml", DocsFilterConfigTemplateSettings.Instance, 180f,
                () => DocsFilterConfigTemplateSettings.Instance.SaveSettings());
            DrawEditableTemplateAssetSection("docs/index.md", DocsIndexTemplateSettings.Instance, 120f,
            ...
            DrawEditableTemplateAssetSection("docs/api/index.md", DocsApiIndexTemplateSettings.Instance, 120f,
        ...
        private static void DrawReadOnlyTemplateAssetSection(
            ...
            PackageAuthoringGui.DrawSection(
                ...
                DrawReadOnlyHeaderLock,
                readOnlyHeaderStyle);
        }

        /// <summary>
        /// Draws the highlighted editable template text area and writes the updated value back to the serialized backing
        /// field.
        /// </summary>
        /// <remarks>
        ...
        private static void DrawTemplateTextArea(SerializedProperty contentProperty, string controlKey,
            float minHeight) {
            ...
            if (!string.Equals(updatedContent, currentContent, StringComparison.Ordinal)) {
        ...
        /// <summary>
        /// Applies serialized changes and persists file-backed template settings even when the current GUI update is an
        /// undo/redo pass.
        /// </summary>
        /// <remarks>
        ...
        /// <c>ProjectSettings/PackageAuthoringTemplates</c>, especially around custom text areas or overlay-based IMGUI
        /// controls
        /// where the visual edit flow is decoupled from Unity's default inspector field pipeline. Editable template providers
        /// also add a narrow
        ...
        /// </remarks>
        private static void ApplyAndSaveOnChangeOrUndo(SerializedObject serializedSettings, Action saveSettings) {
        ...
        /// <summary>
        /// Draws the lock icon shown in read-only template section headers to distinguish built-in content from editable
        /// overrides.
        /// </summary>
        private static void DrawReadOnlyHeaderLock() {
            ...
            Rect lockRect =
                GUILayoutUtility.GetRect(lockIcon, GUIStyle.none, GUILayout.Width(18f), GUILayout.Height(18f));
