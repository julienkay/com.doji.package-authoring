...
- Prevented repository initialization from freezing the Unity editor when git commands block on output pipes, prompts, signing, hooks, or other long-running child processes.
